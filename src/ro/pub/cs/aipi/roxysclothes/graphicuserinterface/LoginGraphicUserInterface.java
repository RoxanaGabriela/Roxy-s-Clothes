...
public class LoginGraphicUserInterface {
	...
	public static void displayLoginGraphicUserInterface(boolean isLoginError, PrintWriter printWriter) {
		...
		content.append("		<form action=\"" + Constants.LOGIN_SERVLET_PAGE_CONTEXT + "\" method=\"post\" name=\"" + Constants.LOGIN_FORM + "\">\n");
		...
		content.append("							<input type=\"text\" name=\"" + Constants.USERNAME + "\" id=\"url\" value=\"" + Constants.USERNAME + "\" onclick=\"this.value = ''\">\n");
		content.append("							<img id=\"url_field\" src=\"./images/user_interface/username.png\" alt=\"\">\n");
		content.append("						</div>\n");
		...
		content.append("						<div id=\"field_inputleft\"></div>\n");
		content.append("						<div id=\"field_inputmiddle\">\n");
		content.append("							<input type=\"password\" name=\"" + Constants.PASSWORD + "\" id=\"url\" value=\"" + Constants.PASSWORD + "\" onclick=\"this.value = ''\">\n");
		content.append("							<img id=\"url_field\" src=\"./images/user_interface/password.png\" alt=\"\">\n");
		content.append("						</div>\n");
		content.append("						<div id=\"field_inputright\"></div>\n");
		content.append("					</div>\n");
		content.append("					<div id=\"submit\">\n");
		content.append("						<input type=\"image\" src=\"./images/user_interface/signin.png\" id=\"submit2\" name=\"" + Constants.SIGNIN.toLowerCase() + "\" value=\"" + Constants.SIGNIN + "\">\n");
		content.append("					</div>\n");
		if (isLoginError) {
			content.append("				<h3 style=\"color: red\">" + Constants.ERROR_USERNAME_PASSWORD + "</h3>\n");
		}
		content.append("				</div>\n");
