...
public class ProductGraphicUserInterface {
	
	public static SizeManager sizeManager = new SizeManager();
	public static ProductManager productManager = new ProductManager();
	
	public ProductGraphicUserInterface() {
	}

	public static void displayProductGraphicUserInterface(String display, List<Record> product, String currentSize, List<List<String>> shoppingCart, PrintWriter printWriter) {
		...
		content.append("		<form action=\"" + Constants.PRODUCT_SERVLET_PAGE_CONTEXT + "\" method=\"post\" name=\"" + Constants.PRODUCT_FORM + "\">\n");
