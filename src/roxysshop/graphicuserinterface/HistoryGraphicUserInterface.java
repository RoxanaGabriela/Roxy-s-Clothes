...
public class HistoryGraphicUserInterface {

	private static UserManager userManager = new UserManager();
	private static InvoiceManager invoiceManager = new InvoiceManager();
	
	public HistoryGraphicUserInterface() {
	}

	public static void displayHistoryGraphicUserInterface(String display, PrintWriter printWriter) {
		...
		content.append("		<form action=\"" + Constants.HISTORY_SERVLET_PAGE_CONTEXT + "\" method=\"post\" name=\"" + Constants.HISTORY_FORM + "\">\n");
		...
		content.append("						</td>\n");
		content.append("						<td>\n");
		List<List<Record>> invoices = invoiceManager.getInvoices(userManager.getIdentifier(display));
