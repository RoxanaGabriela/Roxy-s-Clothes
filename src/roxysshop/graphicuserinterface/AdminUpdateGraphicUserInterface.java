...
public class AdminUpdateGraphicUserInterface {
private static UserManager userManager = new UserManager();
	
	public AdminUpdateGraphicUserInterface() {
	}

	public static void displayAdminUpdateGraphicUserInterface(String display, String isUpdateError, PrintWriter printWriter) {
		...
		content.append("		<form action=\"" + Constants.ADMIN_UPDATE_SERVLET_PAGE_CONTEXT + "\" method=\"post\" name=\"" + Constants.ADMIN_UPDATE_FORM + "\">\n");
