...
import roxysshop.graphicuserinterface.NotLoggedInProductGraphicUserInterface;
import roxysshop.helper.Record;

public class NotLoggedInProductServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try (PrintWriter printWriter = new PrintWriter(response.getWriter())) {
			...
			NotLoggedInProductGraphicUserInterface.displayNotLoggedInProductGraphicUserInterface(product, currentSize, shoppingCart, printWriter);
		}
	}
