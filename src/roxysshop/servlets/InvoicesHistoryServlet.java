...
import roxysshop.graphicuserinterface.InvoicesHistoryGraphicUserInterface;

public class InvoicesHistoryServlet extends HttpServlet {
final public static long serialVersionUID = 10021002L;
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try (PrintWriter printWriter = new PrintWriter(response.getWriter())) {
			...
			InvoicesHistoryGraphicUserInterface.displayInvoicesHistoryGraphicUserInterface(display,
